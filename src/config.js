...
export const REDIRECT_URL_LOCAL = "http://localhost:5173";
export const REDIRECT_URL_PRODUCTION = "https://tennis-app-pi.vercel.app";
...
// App settings
export const APP_NAME = "Tennis Match";
